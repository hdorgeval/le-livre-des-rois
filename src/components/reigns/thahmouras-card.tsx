...
export const ThahmourasCard: React.FC = () => {
  ...
  const thahmourasNode: MarkdownNode = {
    id: 'thahmouras',
    excerpt: 'Règne de Thahmouras Son règne dura 30 ans',
    frontmatter: {
      tags: [],
      date: '',
    ...
    headings: [{ depth: 1, value: 'Règne de Thahmouras' }],
    html: '<h1>Règne de Thahmouras</h1>Son règne dura 30 ans.',
    htmlAst: emptyHtmlAst,
    fields: {
      slug: '/regne-de-thahmouras/',
    },
  ...
  return (
    <Link className="nav-link" to={thahmourasNode.fields.slug} aria-label="Règne de Thahmouras">
