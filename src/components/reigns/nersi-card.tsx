...
export const NersiCard: React.FC = () => {
  ...
  return (
    <Link className="nav-link" to="/regne-de-nersi/" aria-label="Règne de Nersi">
      <div className="card text-center bg-dark text-white border-secondary">
        <div className="card-header pb-0">
          <h5 className="card-title">Nersi</h5>
        </div>
        <div className="card-body card-text">
          <blockquote className="blockquote mb-0">
            <p className="text-secondary">Son règne dura 9 ans.</p>
          </blockquote>
        </div>
