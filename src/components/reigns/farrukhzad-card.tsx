...
export const FarrukhzadCard: React.FC = () => {
  ...
  return (
    <Link className="nav-link" to="/regne-de-farrukhzad/" aria-label="Règne de Farrukhzad">
      <div className="card text-center bg-dark text-white border-secondary">
        <div className="card-header pb-0">
          <h5 className="card-title">Farrukhzad</h5>
        </div>
        <div className="card-body card-text">
          <blockquote className="blockquote mb-0">
            <p className="text-secondary">Son règne dura 1 mois.</p>
          </blockquote>
        </div>
