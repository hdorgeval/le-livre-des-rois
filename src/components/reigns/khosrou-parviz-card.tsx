...
export const KhosrouParvizCard: React.FC = () => {
  ...
  return (
    <Link className="nav-link" to="/regne-de-khosrou-parviz/" aria-label="Règne de Khosrou Parviz">
      <div className="card text-center bg-dark text-white border-secondary">
        <div className="card-header pb-0">
          <h5 className="card-title">Khosrou Parviz</h5>
        </div>
        <div className="card-body card-text">
          <blockquote className="blockquote mb-0">
            <p className="text-secondary">Son règne dura 38 ans.</p>
          </blockquote>
        </div>
