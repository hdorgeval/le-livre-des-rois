...
export const BahramSonOfBahramCard: React.FC = () => {
  ...
  return (
    <Link
      className="nav-link"
      to="/regne-de-bahram-fils-de-bahram/"
      aria-label="Règne de Bahram fils de Bahram"
    >
      <div className="card text-center bg-dark text-white border-secondary">
        <div className="card-header pb-0">
          <h5 className="card-title">Bahram fils de Bahram</h5>
        </div>
        <div className="card-body card-text">
          <blockquote className="blockquote mb-0">
            <p className="text-secondary">Son règne dura 19 ans.</p>
          </blockquote>
        </div>
