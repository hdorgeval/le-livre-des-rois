...
export const BahramGourCard: React.FC = () => {
  ...
  return (
    <Link className="nav-link" to="/regne-de-bahram-gour/" aria-label="Règne de Bahram Gour">
      <div className="card text-center bg-dark text-white border-secondary">
        <div className="card-header pb-0">
          <h5 className="card-title">Bahram Gour</h5>
        </div>
        <div className="card-body card-text">
          <blockquote className="blockquote mb-0">
            <p className="text-secondary">Son règne dura 63 ans.</p>
          </blockquote>
        </div>
