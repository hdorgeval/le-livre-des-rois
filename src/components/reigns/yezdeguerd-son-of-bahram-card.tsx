...
export const YezdeguerdSonOfBahramCard: React.FC = () => {
  ...
  return (
    <Link
      className="nav-link"
      to="/regne-de-yezdeguerd-fils-de-bahram/"
      aria-label="Règne de Yezdeguerd fils de Bahram Gour"
    >
      <div className="card text-center bg-dark text-white border-secondary">
        <div className="card-header pb-0">
          <h5 className="card-title">Yezdeguerd fils de Bahram Gour</h5>
        </div>
        <div className="card-body card-text">
          <blockquote className="blockquote mb-0">
            <p className="text-secondary">Son règne dura 18 ans.</p>
          </blockquote>
        </div>
