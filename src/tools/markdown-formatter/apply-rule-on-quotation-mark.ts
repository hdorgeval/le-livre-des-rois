...
const startOfQuotationRegex =
  /fit dire|firent dire| cri |cria|bénit|dirent|parla|de dire|une lettre|à parler|proclama|reprit|en répétant|appela|écrié|en disant|crier|criant|criait|Le prince dit|, dit| dit|en criant|s’écrièrent|leur disant|leur parla|en lui disant|disait|, disant|en ces mots|se disant|et disant|un dit|et ajouta|Il adressa ainsi la parole|se dit|dit au|dit en se|dit devant|il demanda à|demanda aux|lui demanda|demanda à|lui demanderai|Il dit|ils dirent|Puis, il dit|et lui dit|Ensuite il dit|Ensuite, il dit|et il dit|a dit|et dit|Puis il dit|il se dit|il dit à|dit aux|dit en lui-même|Le roi dit à|il dit aux|dit à|lui dit|se dirent|lui dirent|lui diras|leur dit|dis-lui|répondit|répondre|ils s’écrièrent|en s’écriant|s’écria|ajouta en s’adressant|discours|la réponse|parla ainsi|envoya son salut|reprend|répliqua|apparut en|ces paroles|réponse|adressa|en ces termes|célébrer|voix s’éleva|parole|fit des questions|fit entendre/i;
